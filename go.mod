...
replace (
	...
	github.com/openshift/api => github.com/openshift/api v3.9.1-0.20190905095319-99bed02a44f2+incompatible
	github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20190829151227-84996373cea5
	...
	k8s.io/apimachinery => github.com/soltysh/apimachinery v0.0.0-20190826123331-8db47d5ff559
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20190822060508-785eacbd19ae
	k8s.io/cli-runtime => github.com/soltysh/cli-runtime v0.0.0-20190826144524-6a9c34062bc3
	k8s.io/client-go => github.com/soltysh/k8s-client-go v0.0.0-20190826123859-979626113684
	...
	k8s.io/kubectl => github.com/soltysh/kubectl v0.0.0-20190827065048-b4b8c4e66fa3
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20190822064626-fa8f3d935631
	k8s.io/kubernetes => github.com/soltysh/kubernetes v1.16.0-beta.1.0.20190828083254-fa083e093fc4
