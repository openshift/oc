...
require (
	...
	github.com/gorilla/mux v0.0.0-20190830121156-884b5ffcbd3a // indirect
...
replace (
	...
	github.com/openshift/client-go => github.com/openshift/client-go prebase-1.16.0-beta.2
	k8s.io/api => k8s.io/api kubernetes-1.16.0-rc.2
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver kubernetes-1.16.0-rc.2
	k8s.io/apimachinery => github.com/soltysh/apimachinery oc-4.3-kubernetes-1.16.0-rc.2
	k8s.io/apiserver => k8s.io/apiserver kubernetes-1.16.0-rc.2
	k8s.io/cli-runtime => github.com/soltysh/cli-runtime oc-4.3-kubernetes-1.16.0-rc.2
	k8s.io/client-go => github.com/soltysh/k8s-client-go oc-4.3-kubernetes-1.16.0-rc.2
	k8s.io/cloud-provider => k8s.io/cloud-provider kubernetes-1.16.0-rc.2
	k8s.io/cluster-bootstrap => k8s.io/cluster-bootstrap kubernetes-1.16.0-rc.2
	k8s.io/code-generator => k8s.io/code-generator kubernetes-1.16.0-rc.2
	k8s.io/component-base => k8s.io/component-base kubernetes-1.16.0-rc.2
	k8s.io/cri-api => k8s.io/cri-api kubernetes-1.16.0-rc.2
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib kubernetes-1.16.0-rc.2
	k8s.io/kube-aggregator => k8s.io/kube-aggregator kubernetes-1.16.0-rc.2
	k8s.io/kube-controller-manager => k8s.io/kube-controller-manager kubernetes-1.16.0-rc.2
	k8s.io/kube-proxy => k8s.io/kube-proxy kubernetes-1.16.0-rc.2
	k8s.io/kube-scheduler => k8s.io/kube-scheduler kubernetes-1.16.0-rc.2
	k8s.io/kubectl => github.com/soltysh/kubectl oc-4.3-kubernetes-1.16.0-rc.2
	k8s.io/kubelet => k8s.io/kubelet kubernetes-1.16.0-rc.2
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers kubernetes-1.16.0-rc.2
	k8s.io/metrics => k8s.io/metrics kubernetes-1.16.0-rc.2
	k8s.io/node-api => k8s.io/node-api kubernetes-1.16.0-rc.2
	k8s.io/sample-apiserver => k8s.io/sample-apiserver kubernetes-1.16.0-rc.2
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin kubernetes-1.16.0-rc.2
	k8s.io/sample-controller => k8s.io/sample-controller kubernetes-1.16.0-rc.2
	k8s.io/kubernetes => github.com/soltysh/kubernetes oc-4.3-kubernetes-1.16.0-rc.2
)
