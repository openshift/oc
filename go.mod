...
replace (
	...
	k8s.io/apimachinery => github.com/openshift/kubernetes-apimachinery v0.0.0-20190826115723-26f88640163e
	k8s.io/cli-runtime => github.com/openshift/kubernetes-cli-runtime v0.0.0-20190829103649-200dde6b923a
	k8s.io/client-go => github.com/openshift/kubernetes-client-go v11.0.1-0.20190723174301-07e29e5eae48+incompatible
	k8s.io/kubernetes => github.com/openshift/kubernetes v1.14.1-0.20190913135551-4547c3bba844
)
