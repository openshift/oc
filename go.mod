...
replace (
	...
	k8s.io/component-base => k8s.io/component-base release-1.17
	k8s.io/cri-api => k8s.io/cri-api release-1.17
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib release-1.17
	k8s.io/kube-aggregator => k8s.io/kube-aggregator release-1.17
	...
	k8s.io/sample-apiserver => k8s.io/sample-apiserver release-1.17
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin release-1.17
	k8s.io/sample-controller => k8s.io/sample-controller release-1.17
)
