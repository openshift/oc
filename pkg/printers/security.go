...
func printRangeAllocation(allocation *securityv1.RangeAllocation, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printRangeAllocationList(allocationList *securityv1.RangeAllocationList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printSecurityContextConstraint(scc *securityv1.SecurityContextConstraints, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
	...
	row.Cells = append(row.Cells,
		...
		scc.SELinuxContext.Type,
		scc.RunAsUser.Type,
		scc.FSGroup.Type,
		scc.SupplementalGroups.Type,
		priority,
...
func printSecurityContextConstraintList(sccList *securityv1.SecurityContextConstraintsList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
