...
func (o *options) alerts(ctx context.Context) ([]condition, error) {
	...
	if o.mockData.alertsPath != "" {
		if len(o.mockData.alerts) == 0 {
			return []condition{{
				...
				riskAcceptanceName: "AlertNoTestData",
			}}, nil
		}
	...
	if !haveCritical {
		conditions = append(conditions, condition{Condition: metav1.Condition{
