...
func NewExtract(f kcmdutil.Factory, streams genericiooptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: templates.LongDesc(`
			...
			--command for 'oc', 'openshift-install', or 'openshift-install-fips' will extract the
			binaries directly.
	...
	flags.StringVar(&o.Command, "command", o.Command, "Specify a command such as 'oc', 'openshift-install', or 'openshift-install-fips' to extract the binary for your operating system.")
