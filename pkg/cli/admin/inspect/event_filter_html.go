...
<body>
    ...
    <div class="card card-body">
      ...
      <ul>
        ...
        <ul>
          ...
          <li>YYYYmmDD HHMM[SS] </li>
          <li>YYYYmmDD<b>t</b>HHMM[SS] (t either lower or uppercase) </li>
      ...
      <h2>Examples</h2>
      <ul>
        <li><em>2022-01-01 20:00 - 2022-01-01 21:00</em> - will search for event between 20:00:00 and 21:00:59
          on 2022-01-01</li>
  ...
  <table id="events" class="table table-bordered table-hover table-sm" data-toggle="table" data-search="true"
    data-show-search-clear-button="true" data-filter-control="true" data-advanced-search="true"
