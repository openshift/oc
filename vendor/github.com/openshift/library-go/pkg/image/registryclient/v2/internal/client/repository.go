...
import (
	...
	"github.com/openshift/library-go/pkg/image/registryclient/v2/internal/client/transport"
)
...
func (r *registry) Repositories(ctx context.Context, entries []string, last string) (int, error) {
	...
	if err := clienterrors.HandleHTTPResponseError(resp); err != nil {
		return 0, err
	}
...
func (t *tags) Get(ctx context.Context, tag string) (v1.Descriptor, error) {
	...
	default:
		...
		return v1.Descriptor{}, clienterrors.HandleHTTPResponseError(resp)
	}
}
...
func (t *tags) Untag(ctx context.Context, tag string) error {
	...
	return clienterrors.HandleHTTPResponseError(resp)
}
...
func (bs *blobs) Create(ctx context.Context, options ...distribution.BlobCreateOption) (distribution.BlobWriter, error) {
	...
	default:
		return nil, clienterrors.HandleHTTPResponseError(resp)
	}
}
